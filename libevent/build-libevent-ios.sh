...
do
    ...
    CC="${DEVELOPER}/Toolchains/XcodeDefault.xctoolchain/usr/bin/clang -arch ${ARCH}" \
...
OUTPUT_LIBS="libevent.a libevent_core.a libevent_extra.a libevent_pthreads.a"
